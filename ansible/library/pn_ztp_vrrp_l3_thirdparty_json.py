#!/usr/bin/python
""" PN CLI VRRP L3 with third party switches"""
...
DOCUMENTATION = """
---
module: pn_ztp_vrrp_l3_thirdparty
author: 'Pluribus Networks (devops@pluribusnetworks.com)'
short_description: CLI command to configure VRRP - Layer 3 Setup
description: 
    Virtual Router Redundancy Protocol (VRRP) - Layer 3 Setup. It
    will configure vrrp on all leaf switches, with spines being 
...
def run_cli(module, cli):
    ...
    if err:
        ...
        module.exit_json(
            ...
            exception='',
            summary=results,
            task='CLI commands to configure L3 VRRP ZTP THIRDPARTY',
            stderr=err.strip(),
            msg='L3 VRRP ZTP THIRDPARTY configuration failed',
            changed=False
        )
    else:
        return 'Success'
...
def main():
    ...
    module.exit_json(
        unreachable=False,
        msg = 'L3 VRRP ZTP THIRDPARTY configuration executed successfully',
        summary=results,
        exception='',
        failed=False,
