...
def run_cli(module, cli):
    ...
    if err:
        ...
        module.exit_json(
            ...
            exception='',
            summary=results,
            task='CLI commands to configure L3 thirdparty zero touch provisioning',
            stderr=err.strip(),
            msg='L3 thirdparty ZTP configuration failed',
            changed=False
        )
    else:
        return 'Success'
...
def main():
    ...
    module.exit_json(
        unreachable=False,
        msg = 'L3 thirdparty ZTP configuration executed successfully',
        summary=results,
        exception='',
        failed=False,
