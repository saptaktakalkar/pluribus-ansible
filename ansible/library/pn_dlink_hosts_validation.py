#!/usr/bin/python
""" PN Dlink Hosts File Validation """
...
DOCUMENTATION = """
---
module: pn_dlink_hosts_validation
author: 'Pluribus Networks (devops@pluribusnetworks.com)'
description: Module to validate Ansible hosts/inventory file for Dlink.
options:
    pn_hosts_file_data:
...
EXAMPLES = """
- name: Validate Dlink hosts file
  pn_dlink_hosts_validation:
